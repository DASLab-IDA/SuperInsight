...
def train(X_train: list, y_train: list):
    if os.path.exists("all label trained models/linear_regression_model_corpus.m"):
        linreg = joblib.load('all label trained models/linear_regression_model_corpus.m')
    else:
        linreg = LinearRegression()
        linreg.fit(X_train, y_train)
        joblib.dump(linreg, "all label trained models/linear_regression_model_corpus.m")
    return linreg
...
def predict(linreg: object, X_test: list):
